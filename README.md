...
### 新增功能
- 1688 商品图片采集：输入1688链接自动采集产品图，与上传图片/Amazon采集统一展示
- 中文参考翻译框：提示词右侧双列翻译，支持英中双向翻译
- Gemini-3 Nano Banana 图生图：与 GPT-Image-2 XOR 双模型切换
- 白底产品图铁律：所有提示词内嵌产品参考指令，确保AI以选中产品为主图生成

### 体验优化
- 1688/上传/Amazon 三种图源智能路由
- 采集完成自动清空外部图片输入
- 提示词模板库按钮色彩区分
- 设置页模型名称实时显示
- 保存设置异常防护
